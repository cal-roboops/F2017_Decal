...
HD_PWD='G:/XILINX/EchoSmall/EchoSmall.runs/BaseSystem_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BaseSystem_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BaseSystem_processing_system7_0_0.tcl
