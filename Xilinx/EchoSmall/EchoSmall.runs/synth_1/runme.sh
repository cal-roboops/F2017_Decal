...
HD_PWD='G:/XILINX/EchoSmall/EchoSmall.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BaseSystem_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BaseSystem_wrapper.tcl
