...
HD_PWD='G:/XILINX/EchoSmall/EchoSmall.runs/BaseSystem_Buttons2LEDs_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BaseSystem_Buttons2LEDs_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BaseSystem_Buttons2LEDs_0_1.tcl
