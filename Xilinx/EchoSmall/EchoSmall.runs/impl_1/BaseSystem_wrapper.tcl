...
set rc [catch {
  ...
  add_files -quiet G:/XILINX/EchoSmall/EchoSmall.runs/synth_1/BaseSystem_wrapper.dcp
  ...
  set_param project.isImplRun false
  write_hwdef -force -file BaseSystem_wrapper.hwdef
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force BaseSystem_wrapper_opt.dcp
  create_report "impl_1_opt_report_drc_0" "report_drc -file BaseSystem_wrapper_drc_opted.rpt -pb BaseSystem_wrapper_drc_opted.pb -rpx BaseSystem_wrapper_drc_opted.rpx"
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force BaseSystem_wrapper_routed.dcp
  create_report "impl_1_route_report_drc_0" "report_drc -file BaseSystem_wrapper_drc_routed.rpt -pb BaseSystem_wrapper_drc_routed.pb -rpx BaseSystem_wrapper_drc_routed.rpx"
...
if {$rc} {
  write_checkpoint -force BaseSystem_wrapper_routed_error.dcp
...
set rc [catch {
  ...
  set_property XPM_LIBRARIES {XPM_FIFO XPM_MEMORY} [current_project]
  catch { write_mem_info -force BaseSystem_wrapper.mmi }
  write_bitstream -force BaseSystem_wrapper.bit 
  catch { write_sysdef -hwdef BaseSystem_wrapper.hwdef -bitfile BaseSystem_wrapper.bit -meminfo BaseSystem_wrapper.mmi -file BaseSystem_wrapper.sysdef }
  catch {write_debug_probes -quiet -force BaseSystem_wrapper}
  catch {file copy -force BaseSystem_wrapper.ltx debug_nets.ltx}
