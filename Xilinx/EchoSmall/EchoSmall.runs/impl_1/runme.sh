...
HD_PWD='G:/XILINX/EchoSmall/EchoSmall.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BaseSystem_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BaseSystem_wrapper.tcl -notrace
